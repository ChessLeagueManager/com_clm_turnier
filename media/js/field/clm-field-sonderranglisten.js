 ...
 *
 * Possible attributes:
 *    get buttonSaveSelectedClass() { return this.getAttribute('button-save-selected'); }

    set buttonSaveSelectedClass(value) { this.setAttribute('button-save-selected', value); }
