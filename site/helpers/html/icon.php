...
abstract class JHtmlIcon {
	...
	public static function print_popup($state, $params, $attribs = array ()) {
		$link = CLMTurnierHelperRoute::getGrandPrixRoute($state->get('grand_prix.id'), $state->get('grand_prix.catidEdition'), $state->get('grand_prix.tids'), $state->get('grand_prix.filter'), null, $state->get('grand_prix.rid'));
	...
	public static function email($state, $params, $attribs = array ()) {
		...
		$link = $base .
		JRoute::_(CLMTurnierHelperRoute::getGrandPrixRoute($state->get('grand_prix.id'), $state->get('grand_prix.catidEdition'), $state->get('grand_prix.tids'), $state->get('grand_prix.filter'), $state->get('grand_prix.rids'), $state->get('grand_prix.rid')), false);
	...
	public static function filter($state, $params, $attribs = array ()) {
		...
		$link = CLMTurnierHelperRoute::getGrandPrixRoute($state->get('grand_prix.id'), $state->get('grand_prix.catidEdition'), $state->get('grand_prix.tids'), $filter, $state->get('grand_prix.rids'), $state->get('grand_prix.rid'));
